...
public final class DemoUtil {
  ...
  public static synchronized com.so.luotk.customviews.exoplayer.DownloadTracker getDownloadTracker(Context context) {
    ensureDownloadManagerInitialized(context);
  ...
  private static synchronized void ensureDownloadManagerInitialized(Context context) {
    if (downloadManager == null) {
      ...
      downloadTracker =
          new com.so.luotk.customviews.exoplayer.DownloadTracker(context, getHttpDataSourceFactory(context), downloadManager);
    }
  }
