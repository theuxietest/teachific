package com.so.luotk.customviews.fabRevealMenu.view;
...
import com.so.luotk.customviews.fabRevealMenu.helper.AnimationHelper;
...
import com.so.luotk.customviews.fabRevealMenu.helper.ViewHelper;
...
public class FABRevealMenu extends FrameLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            //background
            mMenuBackground = a.getColor(R.styleable.FABRevealMenu_menuBackgroundColor, ContextCompat.getColor(context, R.color.amp_transparent));
            mOverlayBackground = a.getColor(R.styleable.FABRevealMenu_overlayBackground, ContextCompat.getColor(context, R.color.amp_transparent));
